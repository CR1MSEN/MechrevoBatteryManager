...
namespace MechrevoBatteryManager.Gui
{
    public sealed class MainForm : Form
    {
        ...
        private void ReadEc() { Guard(delegate { var r = ThresholdManager.Read(dllPath.Text); status.Text = English ? string.Format("EC upper={0}, lower={1}, charge-limit gate (0x0742)={2}. No values were written.", r.BeforeUpper, r.BeforeLower, r.ChargeLimitGate) : string.Format("EC 上限={0}，下限={1}，充电限制启用门 (0x0742)={2}。未写入任何值。", r.BeforeUpper, r.BeforeLower, r.ChargeLimitGate); }); }
