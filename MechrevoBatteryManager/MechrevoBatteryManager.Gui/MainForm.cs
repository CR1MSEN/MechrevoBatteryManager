...
namespace MechrevoBatteryManager.Gui
{
    public sealed class MainForm : Form
    {
        ...
        private void ReadEc() { Guard(delegate { var r = ThresholdManager.Read(dllPath.Text); status.Text = English ? string.Format("EC upper={0}, lower={1}. No values were written.", r.BeforeUpper, r.BeforeLower) : string.Format("EC 上限={0}，下限={1}。未写入任何值。", r.BeforeUpper, r.BeforeLower); }); }
