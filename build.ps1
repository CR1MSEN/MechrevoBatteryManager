...
Copy-Item (Join-Path $projectRoot "MechrevoBatteryManager.Service\bin\$Configuration\MechrevoBatteryManager.Service.exe") (Join-Path $dist 'MechrevoBatteryManager.Service.exe') -Force
